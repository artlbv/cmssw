...
l1PhaseIITree = cms.EDAnalyzer("L1PhaseIITreeStep1Producer",
    ...
    scPFL1Puppi = cms.InputTag("l1tSC4PFL1PuppiCorrectedEmulator", ""), #Emulator and corrected JEC; seededcone jets
    scPFL1PuppiMHT = cms.InputTag("l1tSC4PFL1PuppiCorrectedEmulatorMHT", ""), #Emulator for seededcone puppiMHT
    scPFL1PuppiExtended = cms.InputTag("l1tSC4PFL1PuppiExtendedCorrectedEmulator", ""), #Emulator and corrected JEC; seededcone jets from extended tracks/puppi
